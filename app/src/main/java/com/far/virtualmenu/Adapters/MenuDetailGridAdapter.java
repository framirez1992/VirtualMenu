...
public class MenuDetailGridAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tvDescription.setText(objects.get(position).getDescription());
        tvPrice.setText(objects.get(position).getPrice());
        Picasso.with(context).load(objects.get(position).getUrl()).into(img);
